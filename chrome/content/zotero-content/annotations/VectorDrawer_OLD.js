(function ($, R, _) {
	...
	jQuery.extend(VectorDrawer.prototype, {
		...
		drawMode: function(newMode) {
			...
			/*if (newMode == "r")
			{
				this._cont.css({"z-index":12});
			}
			else{
				this._cont.css({"z-index":9});
			}*/
		...
		_buildCanvas: function() {
			...
			self._cont = self._cont || $("<div style=\"z-index:9\" class=\"vd-container\"></div>").appendTo("body");
